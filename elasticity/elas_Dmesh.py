...
# configs
################################################################
INPUT_X = '../data/diffeo/Random_UnitCell_Deform_Grid_X_10_interp.npy'
INPUT_Y = '../data/diffeo/Random_UnitCell_Deform_Grid_Y_10_interp.npy'
INPUT_mask = '../data/diffeo/Random_UnitCell_Deform_Grid_mask_10_interp.npy'
OUTPUT_Sigma = '../data/diffeo/Random_UnitCell_Deform_Grid_sigma_10_interp.npy'
...
for ep in range(epochs):
    ...
    if ep%step_size==0:
        torch.save(model, '../model/elas_Dmesh_' + str(ep))
